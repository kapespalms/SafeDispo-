...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About · SafeDispo" },
      {
        name: "description",
        content: "About SafeDispo — psychiatric disposition and resource navigation.",
      },
    ],
  }),
  component: About,
      ...
      <div className="bg-white px-8 md:px-14 py-10 md:py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="mt-6 font-serif text-[48px] md:text-[72px] leading-[0.95] tracking-tight">
            Safe<span className="italic text-blue-800">Dispo</span>
          </h1>

          <p className="mt-3 font-mono text-[11px] tracking-[0.28em] text-muted-foreground uppercase">
            Psychiatric disposition &amp; discharge · Columbus + Cleveland
          </p>
      ...
      <main className="flex-1 px-8 md:px-14 py-10 md:py-14">
        <div className="max-w-3xl mx-auto space-y-10">
          <p className="text-[15px] leading-relaxed text-muted-foreground">
            SafeDispo was built for the moments when psychiatric disposition is clinically important, time-sensitive, and logistically messy. The tool organizes the pieces clinicians often need in one place: risk assessment, disposition planning, documentation support, crisis resources, outpatient options, and social supports. SafeDispo is designed for emergency psychiatry, consultation-liaison psychiatry, residents, social workers, APPs, and emergency clinicians who need a clearer way to move from assessment to plan.
          </p>
          ...
          <p className="font-mono text-[11px] tracking-[0.22em] text-muted-foreground uppercase">
            SafeDispo includes two core areas
          </p>
          ...
          <div className="pt-6 border-t border-border">
            <p className="text-[15px] leading-relaxed text-muted-foreground">
              SafeDispo is a clinical support and resource navigation tool. It does not replace clinical judgment, emergency evaluation, supervision, local policy, or institutional protocols.
            </p>
          </div>
        </div>
      </main>
